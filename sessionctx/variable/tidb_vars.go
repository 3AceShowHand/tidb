...
const (
	...
	// tidb_merge_join_concurrency is deprecated, use tidb_executor_concurrency instead.
	...
	// tidb_enable_parallel_merge_join is used to control whether to enable the parallelized merge-join algorithm to execute
	TiDBEnableParallelMergeJoin = "tidb_enable_parallel_merge_join"
...
const (
	...
	DefEnableParallelMergeJoin         = true
